...
export const FUNCTION_WORDS: readonly FunctionWord[] = [
  ...
  { word: '的', pos: 'particle', reading: 'de5', does: 'Links a description to the noun it describes.' },
  { word: '地', pos: 'particle', reading: 'de5', does: 'Turns the word before it into a manner: "-ly".' },
  { word: '得', pos: 'particle', reading: 'de5', does: 'Joins a verb to how it goes — the complement follows.' },
  { word: '了', pos: 'particle', reading: 'le5', does: 'Marks a completed action, or a change of state.' },
  { word: '着', pos: 'particle', reading: 'zhe5', does: 'The action is ongoing — a state being held.' },
  { word: '过', pos: 'particle', reading: 'guo4', does: 'Marks experience: this has happened at least once.' },
  { word: '吗', pos: 'particle', reading: 'ma5', does: 'Turns the sentence into a yes/no question.' },
  { word: '呢', pos: 'particle', reading: 'ne5', does: 'Softens a question, or asks it back.' },
  { word: '吧', pos: 'particle', reading: 'ba5', does: 'Suggests, or supposes — makes a sentence less firm.' },
  { word: '啊', pos: 'particle', reading: 'a5', does: 'Softens the sentence and adds warmth or feeling.' },
  ...
  { word: '很', pos: 'adverb', reading: 'hen3', does: 'Marks a plain adjective. Often weaker than "very".' },
  ...
  { word: '不', pos: 'adverb', reading: 'bu4', does: 'Negates. Used for habits, states and the future.' },
  ...
  { word: '又', pos: 'adverb', reading: 'you4', does: 'again — of something that already happened.' },
  { word: '再', pos: 'adverb', reading: 'zai4', does: 'again — of something still to happen.' },
  { word: '就', pos: 'adverb', reading: 'jiu4', does: 'Then, right away — sooner or easier than expected.' },
  { word: '才', pos: 'adverb', reading: 'cai2', does: 'Only then — later or harder than expected.' },
  ...
  { word: '在', pos: 'coverb', reading: 'zai4', does: 'Marks where — or, before a verb, that it is ongoing.' },
  ...
  { word: '对', pos: 'coverb', reading: 'dui4', does: 'Marks who or what is addressed: to, towards.' },
  ...
  { word: '把', pos: 'coverb', reading: 'ba3', does: 'Moves the object in front of the verb, to say what was done to it.' },
  { word: '被', pos: 'coverb', reading: 'bei4', does: 'Marks the passive: the subject has it done to them.' },
  { word: '比', pos: 'coverb', reading: 'bi3', does: 'Marks a comparison: A 比 B is "A more than B".' },
  ...
  // Auxiliaries.
  { word: '是', pos: 'auxiliary', reading: 'shi4', does: 'Links two nouns: is, am, are. Not used with adjectives.' },
  { word: '会', pos: 'auxiliary', reading: 'hui4', does: 'Knows how to — or, of the future, will.' },
  ...
  { word: '个', pos: 'measure', reading: 'ge4', does: 'The general counter, used when no other fits.' },
  ...
  { word: '万', pos: 'number', reading: 'wan4', does: 'ten thousand — the unit Chinese counts in.' },
